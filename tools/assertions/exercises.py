...
def assert_exercise(actual: ExerciseSchema, expected: ExerciseSchema):
    ...
    :param actual: Фактические данный задания.
...
def assert_get_exercise_response(
    get_exercise_response: GetExerciseResponseSchema, create_exercise_response: CreateExerciseResponseSchema
):
    """
...
def assert_get_exercises_response(
    get_exercises_response: GetExercisesResponseSchema, create_exercise_responses: list[CreateExerciseResponseSchema]
):
    """
