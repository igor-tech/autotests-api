...
class TestCourses:
    ...
    def test_get_courses(
        self, courses_client: CoursesClient, function_user: UserFixture, function_course: CourseFixture
    ):
    ...
    def test_create_course(self, courses_client: CoursesClient, function_user: UserFixture, function_file: FileFixture):
        request = CreateCourseRequestSchema(
            created_by_user_id=function_user.response.user.id, preview_file_id=function_file.response.file.id
        )
